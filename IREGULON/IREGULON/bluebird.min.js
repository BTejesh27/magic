!(function (a) {
  "object" == typeof exports
    ...
    ? (global.Promise = a())
    : "undefined" != typeof self && (self.Promise = a());
})(function () {
  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      2: [
        function (require, module, exports) {
          ...
          Async.prototype.invokeLater = function Async$invokeLater(
            ...
            if (process !== void 0 && process.domain != null && !fn.domain) {
        ...
        function (require, module, exports) {
          module.exports = function (Promise, INTERNAL) {
            ...
            Promise.prototype._cancel = function Promise$_cancel() {
              ...
              while (
                (parent = promiseToReject._cancellationParent) !== void 0 &&
        ...
        function (require, module, exports) {
          module.exports = function () {
            ...
            var rignore = new RegExp(
              "\\b(?:[a-zA-Z0-9.]+\\$_\\w+|tryCatch(?:1|2|Apply)|new \\w*PromiseArray|\\w*PromiseArray\\.\\w*PromiseArray|setTimeout|CatchFilter\\$_\\w+|makeNodePromisified|processImmediate|process._tickCallback|nextTick|Async\\$\\w+)\\b"
            );
            var rtraceline = null;
              ...
              function CapturedTrace$PossiblyUnhandledRejection(reason) {
                if (typeof console === "object") {
                  ...
                  if (
                    ...
                    message =
                      "Possibly unhandled " + formatStack(stack, reason);
                  } else {
      ...
      7: [
        ...
        { "./errors.js": 9, "./es5.js": 11, "./util.js": 37 },
      ],
      8: [
        function (require, module, exports) {
          var util = require("./util.js");
      ...
      9: [
        ...
        { "./es5.js": 11, "./global.js": 15, "./util.js": 37 },
      ],
      10: [
        function (require, module, exports) {
          module.exports = function (Promise) {
      ...
      14: [
        ...
        { "./errors.js": 9, "./promise_spawn.js": 22, "./util.js": 37 },
      ],
      15: [
        function (require, module, exports) {
          module.exports = (function () {
          ...
          module.exports = function (
            ...
            Mapping.prototype.iterate = function Mapping$iterate() {
              ...
              for (; i < len; ++i) {
                ...
                try {
                  result[i] = callback.call(receiver, value, i, len);
                } catch (e) {
      ...
      18: [
        function (require, module, exports) {
          module.exports = function (Promise, isPromiseArrayProxy) {
            ...
            var tryCatch1 = util.tryCatch1;
            var errorObj = util.errorObj;
            Promise.prototype.progressed = function Promise$progressed(
              handler
            ) {
              return this._then(void 0, void 0, handler, void 0, void 0);
            };
            Promise.prototype._progress = function Promise$_progress(
              progressValue
            ) {
                  ...
                  if (!(promise instanceof Promise)) {
                    ...
                    if (typeof handler === "function") {
                      ...
                      if (
                        ...
                        if (isPromiseArrayProxy(receiver, promise)) {
        ...
        { "./async.js": 2, "./errors.js": 9, "./util.js": 37 },
      ],
      19: [
        function (require, module, exports) {
          module.exports = function () {
            ...
            Promise.resolve = Promise.fulfilled = function Promise$Resolve(
              value
            ) {
              var ret = new Promise(INTERNAL);
            ...
            Promise.reject = Promise.rejected = function Promise$Reject(
              reason
            ) {
              var ret = new Promise(INTERNAL);
              ret._setTrace(void 0);
            ...
            Promise.attempt = Promise["try"] = function Promise$_Try(
              fn,
              args,
              ctx
            ) {
            ...
            Promise.prototype._proxyPromise = function Promise$_proxyPromise(
              promise
            ) {
              promise._setProxied();
            ...
            Promise.prototype._setLength = function Promise$_setLength(len) {
              this._bitField = (this._bitField & -524288) | (len & 524287);
            };
            ...
            Promise.prototype._receiverAt = function Promise$_receiverAt(
              index
            ) {
              var ret;
              if (index === 0) {
            ...
            Promise.prototype._addCallbacks = function Promise$_addCallbacks(
              ...
              if (index === 0) {
                ...
                this[i + 2] =
                  typeof progress === "function" ? progress : void 0;
              }
              this._setLength(index + 5);
              return index;
            };
            ...
            Promise.prototype._queueSettleAt = function Promise$_queueSettleAt(
              index
            ) {
            ...
            Promise.prototype._rejectPromises =
              function Promise$_rejectPromises() {
      ...
      20: [
        function (require, module, exports) {
          module.exports = function (Promise, INTERNAL) {
            ...
            PromiseArray.prototype._init = function PromiseArray$_init(
              _,
              resolveValueIfEmpty
            ) {
            ...
            PromiseArray.prototype._resolve = function PromiseArray$_resolve(
              value
            ) {
              this._values = null;
            ...
            PromiseArray.prototype.__hardReject__ =
              PromiseArray.prototype._reject = function PromiseArray$_reject(
                reason
              ) {
                this._values = null;
                var trace = canAttach(reason) ? reason : new Error(reason + "");
            ...
            PromiseArray.prototype._promiseProgressed =
              function PromiseArray$_promiseProgressed(progressValue, index) {
                ...
                this._promise._progress({ index: index, value: progressValue });
              };
      ...
      21: [
        function (require, module, exports) {
          ...
          PromiseResolver.prototype.reject = function PromiseResolver$reject(
            reason
          ) {
            var promise = this.promise;
        ...
        { "./async.js": 2, "./errors.js": 9, "./es5.js": 11, "./util.js": 37 },
      ],
      22: [
        function (require, module, exports) {
          module.exports = function (Promise, INTERNAL) {
            ...
            PromiseSpawn.prototype._continue = function PromiseSpawn$_continue(
              result
            ) {
              if (result === errorObj) {
                this._generator = void 0;
            ...
            PromiseSpawn.prototype._throw = function PromiseSpawn$_throw(
              reason
            ) {
        ...
        function (require, module, exports) {
          module.exports = function (Promise, INTERNAL) {
            ...
            function hasPromisified(obj, key) {
              ...
              return containsKey ? isPromisified(obj[key + "Async"]) : false;
            }
            ...
            function makeNodePromisifiedEval(
              ...
              function generateArgumentSwitchCase() {
                ...
                ret +=
                  "default: var args = new Array(len + 1);var i = 0;for (var i = 0; i < len; ++i) {    args[i] = arguments[i];}args[i] = fn;" +
              ...
              return new Function(
                ...
                "var ret = function " +
                  ...
                  ') {"use strict";var len = arguments.length;var promise = new Promise(INTERNAL);promise._setTrace(void 0);var fn = nodebackForPromise(promise);try {switch(len) {' +
                  generateArgumentSwitchCase() +
                  "}}catch(e){ var wrapped = maybeWrapAsError(e);promise._attachExtraTrace(wrapped);promise._reject(wrapped);}return promise;}; ret.__isPromisified__ = true; return ret;"
              )(
                Promise,
                callback,
                receiver,
            ...
            function _promisify(callback, receiver, isAll) {
              if (isAll) {
                ...
                for (var i = 0, len = methods.length; i < len; i += 2) {
                  ...
                  callback[promisifiedKey] = makeNodePromisified(
                    key,
                    THIS,
                    key,
                    fn
        ...
        function (require, module, exports) {
          module.exports = function (Promise, PromiseArray) {
            var PropertiesPromiseArray =
              require("./properties_promise_array.js")(Promise, PromiseArray);
            var util = require("./util.js");
            var apiRejection = require("./errors_api_rejection")(Promise);
      ...
      27: [
        ...
        { "./errors_api_rejection.js": 10, "./util.js": 37 },
      ],
      28: [
        function (require, module, exports) {
          module.exports = function (
            ...
            Reduction.prototype.fulfill = function Reduction$fulfill(
              value,
              index
            ) {
              this.accum = value;
            ...
            Reduction.prototype.iterate = function Reduction$iterate() {
              ...
              for (; i < len; ++i) {
                ...
                if (result instanceof Promise) {
                  result._then(this.fulfill, this.reject, void 0, this, i);
                  return;
                }
              }
            ...
            function Promise$_slowReduce(promises, fn, initialValue, useBound) {
              return initialValue._then(
                function (initialValue) {
                  return Promise$_Reduce(promises, fn, initialValue, useBound);
                },
                void 0,
                void 0,
                void 0,
            ...
            function Promise$_Reduce(promises, fn, initialValue, useBound) {
              ...
              if (useBound === true && promises._isBound()) {
                fn = { fn: fn, receiver: promises._boundTo };
              }
              if (initialValue !== void 0) {
                ...
                return Promise$_CreatePromiseArray(
                  ...
                  ._then(
                    ...
                    void 0,
                    void 0,
                    { fn: fn, initialValue: initialValue },
                    void 0
                  );
              }
              return Promise$_CreatePromiseArray(
              ...
              function SomePromiseArray$_promiseRejected(reason) {
                ...
                if (this.howMany() > this._canPossiblyFulfill()) {
                  if (this._values.length === this.length()) {
                    ...
                    this._reject(
                      this._values.slice(this.length() + this._holes)
                    );
                  }
                }
              };
      ...
      34: [
        function (require, module, exports) {
          module.exports = function (Promise) {
            ...
            PromiseInspection.prototype.value = Promise.prototype.value =
            ...
            PromiseInspection.prototype.error = Promise.prototype.reason =
