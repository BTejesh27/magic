...
(function (t, e, i) {
  (function (t) {
    ...
    function a(t) {
      ...
      return n(t)
        ? k
        : (n(t.metadata) && (t.metadata = { type: t.metadata }),
          "content" in t &&
            ((e = t.content),
            n(e) || e.jquery || e.done
              ? (e = t.content = { text: (i = r(e) ? k : e) })
              : (i = e.text),
            "ajax" in e &&
              ((o = e.ajax),
              (a = o && o.once !== k),
              ...
              (e.text = function (t, e) {
                var n =
                    i || s(this).attr(e.options.content.attr) || "Loading...",
                  r = s
                    .ajax(s.extend({}, o, { context: e }))
                    .then(o.success, E, o.error)
                    .then(
                      function (t) {
          ...
          "style" in t && n(t.style) && (t.style = { classes: t.style }),
          s.each(R, function () {
    ...
    function y(t, i, n) {
      ...
      if (
        ((c = s.extend(
          ...
          T.defaults,
          n,
          "object" == typeof m ? a(m) : E,
          a(g || f)
        )),
        (h = c.position),
        (c.id = i),
        "boolean" == typeof c.content.text)
      ) {
      ...
      if (
        (h.container.length || (h.container = p),
        h.target === k && (h.target = u),
        c.show.target === k && (c.show.target = u),
        c.show.solo === W && (c.show.solo = h.container.closest("body")),
        c.hide.target === k && (c.hide.target = u),
        c.position.viewport === W && (c.position.viewport = h.container),
      ...
      return (
        ...
        c.suppress &&
          (d = t.attr("title")) &&
          t.removeAttr("title").attr(se, d).attr("title", ""),
        (r = new o(t, c, i, !!l)),
        t.data(X, r),
    ...
    (j = o.prototype),
      ...
      (j.render = function (t) {
        ...
        return (
          ...
          h &&
            (this._createTitle(),
            s.isFunction(h) || d.push(this._updateTitle(h, k))),
          l && this._createButton(),
          s.isFunction(a) || d.push(this._updateContent(a, k)),
          (this.rendered = W),
          this._setWidget(),
          s.each(R, function (t) {
            var e;
          ...
          this._when(d).then(function () {
            i._trigger("render"),
              ...
              i.hiddenDuringWait ||
                (!o.show.ready && !t) ||
                i.toggle(W, n.event, k),
              (i.hiddenDuringWait = k);
          }),
          (T.api[this.id] = this),
          this
        );
        ...
        function e() {
          if (!this.destroyed) {
            ...
            this.rendered &&
              ...
              this.options.suppress && e && t.attr("title", e).removeAttr(se),
              this._unbind(t),
              (this.options =
                this.elements =
                this.cache =
      ...
      (M = j.checks =
        {
          builtin: {
            ...
            "^content.title$": function (t, e, s) {
              return s
                ? (s && !this.elements.title && this._createTitle(),
                  this._updateTitle(s),
                  i)
                : this._removeTitle();
            },
    ...
    (j.set = function (t, e) {
      ...
      return (
        ...
        "string" == typeof t
          ? ((o = t), (t = {}), (t[o] = e))
          : (t = s.extend({}, t)),
        s.each(t, function (e, o) {
          if (n && re.test(e)) return delete t[e], i;
          var a,
            l = h(c, e.toLowerCase());
          (a = l[0][l[1]]),
            (l[0][l[1]] = o && o.nodeType ? s(o) : o),
            (r = ne.test(e) || r),
            (t[e] = [l[0], l[1], o, a]);
        }),
        a(c),
        (this.positioning = W),
        s.each(t, s.proxy(l, this)),
        (this.positioning = k),
        this.rendered &&
          this.tooltip[0].offsetWidth > 0 &&
          r &&
          this.reposition("mouse" === c.position.target ? E : this.cache.event),
        this
      );
    }),
      ...
      (j._createTitle = function () {
        ...
        t.titlebar && this._removeTitle(),
          (t.titlebar = s("<div />", {
            class:
              X + "-titlebar " + (this.options.style.widget ? c("header") : ""),
          })
            .append(
              (t.title = s("<div />", {
                id: e,
        ...
        if (s.isArray(c) && 2 === c.length)
          ...
          (p = { x: F, y: D }),
            !z || !z.pageX || (!g.mouse && i && i.pageX)
              ? (i && i.pageX) ||
                ...
                a.origin.pageX
                  ? (i = a.origin)
                  : (!i ||
                      (i && ("resize" === i.type || "scroll" === i.type))) &&
                    (i = a.event))
              : (i = z),
            "static" !== _ && (x = f.offset()),
            j.body.offsetWidth !==
              (t.innerWidth || j.documentElement.clientWidth) &&
              (r = s(e.body).offset()),
            (x = {
            ...
            g.mouse &&
              C &&
              z &&
              ((x.left -= (z.scrollX || 0) - T.scrollLeft()),
              (x.top -= (z.scrollY || 0) - T.scrollTop()));
        else {
          if (
            ("event" === c
              ...
              : "event" !== c &&
                (a.target = s(c.jquery ? c : this.elements.target)),
            (c = a.target),
            (c = s(c).eq(0)),
            0 === c.length)
          )
            return this;
          c[0] === e || c[0] === t
            ? ((b = oe.iOS ? t.innerWidth : c.width()),
              (w = oe.iOS ? t.innerHeight : c.height()),
              c[0] === t &&
                (x = {
                  top: (u || c).scrollTop(),
                  left: (u || c).scrollLeft(),
            ...
            ? (n = R.imagemap(this, c, p, R.viewport ? m : k))
            : R.svg && c && c[0].ownerSVGElement
            ? (n = R.svg(this, c, p, R.viewport ? m : k))
            : ((b = c.outerWidth(k)), (w = c.outerHeight(k)), (x = c.offset())),
            n &&
              ((b = n.width), (w = n.height), (r = n.offset), (x = n.position)),
            (x = this.reposition.offset(c, x, f)),
            ((oe.iOS > 3.1 && 4.1 > oe.iOS) ||
              (oe.iOS >= 4.3 && 4.33 > oe.iOS) ||
              (!oe.iOS && "fixed" === _)) &&
              ((x.left -= T.scrollLeft()), (x.top -= T.scrollTop())),
            (!n || (n && n.adjustable !== k)) &&
              ((x.left += p.x === P ? b : p.x === N ? b / 2 : 0),
              (x.top += p.y === O ? w : p.y === N ? w / 2 : 0));
        }
        return (
          (x.left += g.x + (d.x === P ? -v : d.x === N ? -v / 2 : 0)),
          (x.top += g.y + (d.y === O ? -y : d.y === N ? -y / 2 : 0)),
          R.viewport
            ? ((x.adjusted = R.viewport(this, x, l, b, w, v, y)),
              r && x.adjusted.left && (x.left += r.left),
              r && x.adjusted.top && (x.top += r.top))
            : (x.adjusted = { left: 0, top: 0 }),
          this._trigger("move", [x, u.elem || u], i)
            ? (delete x.adjusted,
              ...
              !s.isFunction(l.effect)
                ? h.css(x)
                : s.isFunction(l.effect) &&
                  (l.effect.call(h, this, s.extend({}, x)),
                  h.queue(function (t) {
                    s(this).css({ opacity: "", height: "" }),
                      oe.ie && this.style.removeAttribute("filter"),
                      t();
                  })),
              (this.positioning = k),
              this)
        ...
        do
          "static" !== (a = s.css(p, "position")) &&
            ("fixed" === a
              ...
              : ((h = s(p).position()),
                (h.left += parseFloat(s.css(p, "borderLeftWidth")) || 0),
                (h.top += parseFloat(s.css(p, "borderTopWidth")) || 0)),
            (i.left -= h.left + (parseFloat(s.css(p, "marginLeft")) || 0)),
            (i.top -= h.top + (parseFloat(s.css(p, "marginTop")) || 0)),
            r ||
    ...
    (ae.invert = function (t, e) {
      ...
      (ae.string = function () {
        ...
        return t === e
          ? t
          : this.precedance === L || (this.forceY && "center" !== e)
          ? e + " " + t
          : t + " " + e;
      }),
      (ae.abbrev = function () {
      ...
      (j.toggle = function (t, i) {
        ...
        return (
          (typeof t).search("boolean|number") && (t = !m),
          (a = !r.is(":animated") && m === t && y),
          (h = a ? E : !!this._trigger(c, [90])),
          this.destroyed
            ? this
            : (h !== k && t && this.focus(i),
              !h || a
                ? this
                : (s.attr(r[0], "aria-hidden", !t),
                  t
                    ? ((o.origin = d(this.mouse)),
                      s.isFunction(f.text) && this._updateContent(f.text, k),
                      s.isFunction(f.title) && this._updateTitle(f.title, k),
                      !I &&
                        "mouse" === u.target &&
                        u.adjust.mouse &&
                        (s(e).bind("mousemove." + X, this._storeMouse),
                        (I = W)),
                      g || r.css("width", r.outerWidth(k)),
                      this.reposition(i, arguments[2]),
                      g || r.css("width", ""),
                      p.solo &&
                        ("string" == typeof p.solo ? s(p.solo) : s(U, p.solo))
                          .not(r)
                          .not(p.target)
                    ...
                    : (clearTimeout(this.timers.show),
                      delete o.origin,
                      I &&
                        !s(U + '[tracking="true"]:visible', p.solo).not(r)
                          .length &&
                        (s(e).unbind("mousemove." + X), (I = k)),
                      this.blur(i)),
                  (l = s.proxy(function () {
                    t
                      ? (oe.ie && r[0].style.removeAttribute("filter"),
                        r.css("overflow", ""),
                        "string" == typeof p.autofocus &&
                          s(this.options.show.autofocus, r).focus(),
                  ...
                  p.effect === k || v === k
                    ...
                    ? (r.stop(1, 1),
                      p.effect.call(r, this),
                      r.queue("fx", function (t) {
                        l(), t();
                      }))
                    : r.fadeTo(90, t ? 1 : 0, l),
                  t && p.target.trigger("qtip-" + this.id + "-inactive"),
                  this))
        );
      }),
      (j.show = function (t) {
          ...
          i.hasClass(Z) ||
            (this._trigger("focus", [n], t) &&
              (o !== n &&
                ...
                e.filter("." + Z).qtip("blur", t)),
              (i.addClass(Z)[0].style.zIndex = n))),
          this
        );
      }),
      (j.blur = function (t) {
        ...
        return this.destroyed
          ...
          : ("toggle" === t
              ? (t = !(this.rendered
                  ...
                  : this.disabled))
              : "boolean" != typeof t && (t = W),
            this.rendered &&
              this.tooltip.toggleClass(ee, t).attr("aria-disabled", t),
            (this.disabled = !!t),
            this);
      }),
      (j.enable = function () {
      ...
      (j._setWidget = function () {
        var t = this.options.style.widget,
          ...
          s = i.hasClass(ee);
        i.removeClass(ee),
          (ee = t ? "ui-state-disabled" : "qtip-disabled"),
          i.toggleClass(ee, s),
          i
            .toggleClass("ui-helper-reset " + c(), t)
            .toggleClass(K, this.options.style.def && !t),
          e.content && e.content.toggleClass(c("content"), t),
          e.titlebar && e.titlebar.toggleClass(c("header"), t),
          e.button && e.button.toggleClass(X + "-icon", !t);
      }),
      ...
      (j._bind = function (t, e, i, o, n) {
        var r = "." + this._id + (o ? "-" + o : "");
        e.length &&
          s(t).bind((e.split ? e : e.join(r + " ")) + r, s.proxy(i, n || this));
      }),
    ...
    s(function () {
      v(U, ["mouseenter", "mouseleave"], function (t) {
        ...
        e
          ? (this.focus(t),
            i.hasClass(J) && !i.hasClass(ee) && clearTimeout(this.timers.hide))
      ...
      (j._trigger = function (t, e, i) {
        ...
        return (
          (o.originalEvent = (i && s.extend({}, i)) || this.cache.event || E),
          (this.triggering = t),
      ...
      (j._assignEvents = function () {
        ...
        s.each(o.events, function (t, e) {
          ...
          "number" == typeof o.hide.inactive &&
            (this._bind(a, "qtip-" + this.id + "-inactive", g),
            this._bind(h.add(r), T.inactiveEvents, g, "-inactive")),
          this._bindEvents(v, y, a, h, u, f),
          ...
          (n.adjust.resize || c.length) &&
            this._bind(s.event.special.resize ? c : p, "resize", m),
          n.adjust.scroll && this._bind(p.add(n.container), "scroll", m);
      }),
        ...
        function (t, e, o) {
          ...
          return (!arguments.length && c) || "api" === n
            ...
            ? (this.each(function () {
                ...
                if (!t) return W;
                if (
                  (l && l.timeStamp && (t.cache.event = l),
                  !e || ("option" !== n && "options" !== n))
                )
                  t[n] && t[n].apply(t, h);
                else {
            ...
            : ((c = a(s.extend(W, {}, t))),
              this.each(function (t) {
                var e, o;
                return (
                  (o = s.isArray(c.id) ? c.id[t] : c.id),
                  (o =
                    !o || o === k || 1 > o.length || T.api[o] ? T.nextid++ : o),
                  (e = y(s(this), o, c)),
                  e === k
                    ? W
                    : ((T.api[o] = e),
          ...
          attr: function (t, e) {
            if (this.length) {
              var i = this[0],
                o = "title",
                n = s.data(i, "qtip");
              if (t === o && n && "object" == typeof n && n.options.suppress)
                return 2 > arguments.length
                  ? s.attr(i, se)
                  : (n &&
                      n.options.content.attr === o &&
                      n.cache.attr &&
                      n.set("content.text", e),
                    this.attr(se, e));
            }
    ...
    s.extend(x.prototype, {
      init: function (t) {
        ...
        (i =
          this.element =
          t.elements.tip =
            s("<div />", { class: X + "-tip" }).prependTo(t.tooltip)),
          me
            ? ((e = s("<canvas />").appendTo(this.element)[0].getContext("2d")),
              (e.lineJoin = "miter"),
              (e.miterLimit = 1e5),
              e.save())
            : ((e = qe("shape", 'coordorigin="0,0"', "position:absolute;")),
      ...
      _parseRadius: function (t) {
        ...
        return 9 > oe.ie
          ? 0
          : _((this._useTitle(t) && e.titlebar) || e.content, i) ||
              _(e.tooltip, i) ||
              0;
      },
      ...
      _calculateSize: function (t) {
        ...
        return (
          (p[2] = Math.sqrt(l(p[0], 2) - l(this.border, 2))),
          (p[3] = Math.sqrt(l(p[1], 2) - l(this.border, 2))),
          (e = d + p[2] + p[3] + (a ? 0 : p[0])),
          (i = e / d),
          (s = [c(i * n), c(i * r)]),
          o ? s : s.reverse()
      ...
      create: function () {
        var t = (this.corner =
          (me || oe.ie) && this._parseCorner(this.options.corner));
        return (
        ...
        e || (e = this.qtip.cache.corner || this.corner),
          v === k
            ...
            : ((v = new z(v)),
              ...
              "inherit" === v.x
                ...
                : "inherit" === v.y
                ? (v.y = e.y)
                : v.x === v.y && (v[e.precedance] = e[e.precedance])),
          (n = v.precedance),
          e.precedance === S ? this._swapDimensions() : this._resetDimensions(),
          (o = this.color = this._parseColours(e)),
          o[1] !== fe
            ? ((d = this.border = this._parseWidth(e, e[e.precedance])),
              g.border && 1 > d && !ve.test(o[1]) && (o[0] = o[1]),
              (this.border = d = g.border !== W ? g.border : d))
            : (this.border = d = 0),
          (c = this.size = this._calculateSize(e)),
          ...
          me
            ? ((r = f[0].getContext("2d")),
              ...
              (a = this._calculateTip(v, m, xe)),
              (h = this._calculateTip(v, this.size, xe)),
              f.attr(A, c[0] * xe).attr(B, c[1] * xe),
              f.css(A, c[0]).css(B, c[1]),
              this._drawCoords(r, h),
              (r.fillStyle = o[1]),
              r.fill(),
              r.translate(l[0] * xe, l[1] * xe),
            ...
            : ((a = this._calculateTip(v)),
              (a =
                ...
                " xe"),
              (l[2] =
                d && /^(r|b)/i.test(e.string()) ? (8 === oe.ie ? 2 : 1) : 0),
              f
                .css({
      ...
      calculate: function (t, e) {
        ...
        return (
          ...
          (o = [t.x, t.y]),
          i === S && o.reverse(),
          s.each(o, function (s, o) {
            var a, c, d;
            o === N
              ? ((a = i === L ? F : D),
                (l[a] = "50%"),
                (l[ce + "-" + a] = -Math.round(e[i === L ? 0 : 1] / 2) + h))
              : ((a = n._parseWidth(t, o, r.tooltip)),
                (c = n._parseWidth(t, o, r.content)),
                (d = n._parseRadius(t)),
                (l[o] = Math.max(-n.border, s ? c : h + (d > a ? d : -a))));
          }),
          (l[t[i]] -= e[i === S ? 0 : 1]),
          a
      ...
      reposition: function (t, e, s) {
        function o(t, e, i, s, o) {
          t === V && l.precedance === e && c[s] && l[i] !== N
            ...
            : t !== V &&
              c[s] &&
              (l[e] = l[e] === N ? (c[s] > 0 ? s : o) : l[e] === s ? o : s);
        }
        function n(t, e, o) {
          l[t] === N
            ? (g[ce + "-" + e] = f[t] = r[ce + "-" + e] - c[e])
            : ((a = r[o] !== i ? [c[e], -r[e]] : [-c[e], r[e]]),
              (f[t] = Math.max(a[0], a[1])) > a[0] &&
                ((s[e] -= c[e]), (f[e] = k)),
              (g[r[o] !== i ? o : e] = f[t]));
        }
        if (this.enabled) {
          var r,
            ...
            p = d[0],
            u = d[1] || d[0],
            f = { left: k, top: k, x: 0, y: 0 },
            g = {};
          this.corner.fixed !== W &&
            (o(p, S, L, F, P),
            o(u, L, S, D, O),
            l.string() === h.corner.string() ||
              (h.cornerTop === c.top && h.cornerLeft === c.left) ||
              this.update(l, k)),
            (r = this.calculate(l)),
            r.right !== i && (r.left = -r.right),
            r.bottom !== i && (r.top = -r.bottom),
            (r.user = this.offset),
            (f.left = p === V && !!c.left) && n(S, F, P),
            (f.top = u === V && !!c.top) && n(L, D, O),
            this.element
              .css(g)
              .toggle(
                !((f.x && f.y) || (l.x === N && f.y) || (l.y === N && f.x))
              ),
            (s.left -= r.left.charAt
              ? r.user
              : p !== V || f.top || (!f.left && !f.top)
              ? r.left + this.border
              : 0),
            (s.top -= r.top.charAt
              ? r.user
              : u !== V || f.left || (!f.left && !f.top)
              ? r.top + this.border
              : 0),
            (h.cornerLeft = c.left),
            (h.cornerTop = c.top),
      ...
      (le.initialize = "render"),
      (le.sanitize = function (t) {
        if (t.style && "tip" in t.style) {
          var e = t.style.tip;
          "object" != typeof e && (e = t.style.tip = { corner: e }),
    ...
    (Te = function () {
      function t(t) {
        ...
        var e,
          i,
          o,
          n = !isNaN(s.attr(t, "tabindex")),
          r = t.nodeName && t.nodeName.toLowerCase();
        return "area" === r
          ? ((e = t.parentNode),
            (i = e.name),
            t.href && i && "map" === e.nodeName.toLowerCase()
              ? ((o = s("img[usemap=#" + i + "]")[0]), !!o && o.is(":visible"))
              : !1)
      ...
      function o(t) {
        if (h.is(":visible")) {
          ...
          (e =
            1 > l.length
              ? k
              : parseInt(l[0].style.zIndex, 10) >
                parseInt(a[0].style.zIndex, 10)),
            e || o.closest(U)[0] === a[0] || i(o),
            (r = t.target === c[c.length - 1]);
        }
      }
      var n,
        r,
      ...
      s.extend(l, {
        init: function () {
          return (
            ...
            s(e.body).bind("focusin" + ze, o),
            s(e).bind("keydown" + ze, function (t) {
        ...
        update: function (e) {
          (n = e),
            (c =
              e.options.show.modal.stealfocus !== k
        ...
        toggle: function (t, o, r) {
          ...
          return (
            l.update(t),
            o && d.stealfocus !== k && i(s(":focus")),
            h.toggleClass("blurs", d.blur),
            o && h.appendTo(e.body),
            (h.is(":animated") && f === o && a !== k) || (!o && g.length)
              ? l
              : (h.stop(W, k),
                s.isFunction(p)
                  ? p.call(h, o)
                  : p === k
                  ? h[u]()
                  : h.fadeTo(parseInt(r, 10) || 90, o ? 1 : 0, function () {
                      o || h.hide();
                    }),
                o ||
                  h.queue(function (t) {
                    h.css({ left: "", top: "" }),
                      s(ze).length || h.detach(),
                      t();
                  }),
                (a = o),
                n.destroyed && (n = E),
      ...
      (Te = new Te()),
      s.extend(q.prototype, {
        init: function (t) {
          var e = t.tooltip;
          return this.options.on
            ? ((t.elements.overlay = Te.elem),
              e.addClass(je).css("z-index", T.modal_zindex + s(ze).length),
              t._bind(
                e,
                ...
                function (t, i, o) {
                  ...
                  if (t.target === e[0])
                    if (
                      ...
                      s(n.relatedTarget).closest(Te.elem[0]).length
                    )
                      try {
                        t.preventDefault();
                      } catch (r) {}
                      ...
                      (!n || (n && "tooltipsolo" !== n.type)) &&
                        this.toggle(t, "tooltipshow" === t.type, o);
                },
                this._ns,
                this
              ),
                ...
                function (t, i) {
                  if (!t.isDefaultPrevented() && t.target === e[0]) {
                    ...
                    (Te.elem[0].style.zIndex = n - 1),
                      ...
                      o.filter("." + Z).qtip("blur", t.originalEvent),
                      (e.addClass(Z)[0].style.zIndex = n),
                      Te.update(i);
                    try {
                      t.preventDefault();
                    } catch (a) {}
              ...
              t._bind(
                ...
                function (t) {
                  t.target === e[0] &&
                    s(ze).filter(":visible").not(e).last().qtip("focus", t);
                },
                this._ns,
                this
              ),
        ...
        toggle: function (t, e, s) {
          return t && t.isDefaultPrevented()
            ? this
            : (Te.toggle(this.qtip, !!e, s), i);
        },
        destroy: function () {
          this.qtip.tooltip.removeClass(je),
            this.qtip._unbind(this.qtip.tooltip, this._ns),
            Te.toggle(this.qtip, k),
      ...
      (Ce.sanitize = function (t) {
        t.show &&
          ("object" != typeof t.show.modal
            ? (t.show.modal = { on: !!t.show.modal })
            : t.show.modal.on === i && (t.show.modal.on = W));
      }),
      (T.modal_zindex = T.zindex - 200),
      ...
      s.extend(W, T.defaults, {
        show: {
          modal: { on: k, effect: W, blur: W, stealfocus: W, escape: W },
        },
      }),
            ...
            w
              ...
              : ((o *= i === $ ? 2 : 0),
                j > 0 && (p !== n || z > 0)
                  ...
                  : z > 0 &&
                    (p !== r || j > 0) &&
                    ((s[n] -= (p === N ? -M : M) + o), d.invert(t, r)),
                v > s[n] && -s[n] > z && ((s[n] = c), (d = _.clone()))),
            s[n] - c
          );
        }
        var c,
          ...
          I = i.cache,
          W = { left: 0, top: 0 };
        return z.jquery && b[0] !== t && b[0] !== e.body && "none" !== q.method
          ? ((u = M.offset() || W),
            (f = "static" === M.css("position")),
            (c = "fixed" === w.css("position")),
            (g = z[0] === t ? z.width() : z.outerWidth(k)),
            (m = z[0] === t ? z.height() : z.outerHeight(k)),
            (v = { left: c ? 0 : z.scrollLeft(), top: c ? 0 : z.scrollTop() }),
            (y = z.offset() || W),
            ("shift" !== T || "shift" !== j) && (d = _.clone()),
            (W = {
            ...
            d &&
              ...
              w
                .removeClass(i.cache.lastClass)
                .addClass((i.cache.lastClass = p)),
            W)
          : W;
      }),
      (R.polys = {
        polygon: function (t, e) {
          var i,
            ...
            d = 0;
          for (r = t.length; r--; )
            (i = [parseInt(t[--r], 10), parseInt(t[r + 1], 10)]),
              i[0] > n.position.right && (n.position.right = i[0]),
              i[0] < n.position.left && (n.position.left = i[0]),
              i[1] > n.position.bottom && (n.position.bottom = i[1]),
              i[1] < n.position.top && (n.position.top = i[1]),
              a.push(i);
          if (
            ((s = n.width = Math.abs(n.position.right - n.position.left)),
            (o = n.height = Math.abs(n.position.bottom - n.position.top)),
            "c" === e.abbrev())
          )
            n.position = {
            ...
            for (; s > 0 && o > 0 && h > 0 && l > 0; )
              for (
                ...
                (c = a[r][0] - n.position.left),
                  (d = a[r][1] - n.position.top),
                  ((e.x === F && c >= h) ||
                    (e.x === P && h >= c) ||
                    (e.x === N && (h > c || c > n.width - h)) ||
                    (e.y === D && d >= l) ||
                    (e.y === O && l >= d) ||
                    (e.y === N && (l > d || d > n.height - l))) &&
                    a.splice(r, 1);
      ...
      (R.svg = function (t, i, o) {
        ...
        (n = y.attr("width") || y.width() || parseInt(y.css("width"), 10)),
          (r = y.attr("height") || y.height() || parseInt(y.css("height"), 10));
        ...
        switch ((x && ((b += x / n), (w += x / r)), v.nodeName)) {
          ...
          case "polyline":
            for (
              u = v.points || [
                { x: v.x1.baseVal.value, y: v.y1.baseVal.value },
                { x: v.x2.baseVal.value, y: v.y2.baseVal.value },
              ],
                f = [],
                p = -1,
                c = u.numberOfItems || u.length;
              c > ++p;

            )
              (d = u.getItem ? u.getItem(p) : u[p]),
                f.push.apply(f, [d.x, d.y]);
      ...
      (R.imagemap = function (t, e, i) {
        ...
        var o,
          ...
          a,
          h,
          l = e.attr("shape").toLowerCase().replace("poly", "polygon"),
        ...
        return (
          (o = c.offset()),
          (o.left += Math.ceil((c.outerWidth(k) - c.width()) / 2)),
          (o.top += Math.ceil((c.outerHeight(k) - c.height()) / 2)),
    ...
    s.extend(C.prototype, {
      ...
      init: function (i) {
        ...
        1 > s("select, object").length &&
          ((this.bgiframe = i.elements.bgiframe = s(Ie).appendTo(o)),
          i._bind(o, "tooltipmove", this.adjustBGIFrame, this._ns, this)),
          (this.redrawContainer = s("<div/>", {
            id: X + "-rcontainer",
          }).appendTo(e.body)),
          i.elements.overlay &&
            i.elements.overlay.addClass("qtipmodal-ie6fix") &&
            (i._bind(t, ["scroll", "resize"], this._scroll, this._ns, this),
            i._bind(o, ["tooltipshow"], this._scroll, this._ns, this)),
          this.redraw();
      },
      adjustBGIFrame: function () {
        var t,
          e,
          i = this.qtip.tooltip,
          s = { height: i.outerHeight(k), width: i.outerWidth(k) },
          o = this.qtip.plugins.tip,
          n = this.qtip.elements.tip;
        (e = parseInt(i.css("borderLeftWidth"), 10) || 0),
          (e = { left: -e, top: -e }),
          o &&
            n &&
            ((t = "x" === o.corner.precedance ? [A, F] : [B, D]),
            (e[t[1]] -= n[t[0]]())),
      ...
      redraw: function () {
        ...
        return (
          (this.qtip.drawing = 1),
          n.height && o.css(B, n.height),
          n.width
            ? o.css(A, n.width)
            : (o.css(A, "").appendTo(this.redrawContainer),
              (e = o.width()),
              1 > e % 2 && (e += 1),
              (i = o.css("maxWidth") || ""),
              (s = o.css("minWidth") || ""),
              (t = (i + s).indexOf("%") > -1 ? r.width() / 100 : 0),
              (i = (i.indexOf("%") > -1 ? t : 1) * parseInt(i, 10) || e),
              (s = (s.indexOf("%") > -1 ? t : 1) * parseInt(s, 10) || 0),
              (e = i + s ? Math.min(Math.max(e, s), i) : e),
              o.css(A, Math.round(e)).appendTo(r)),
          (this.drawing = 0),
          this
        );
      },
